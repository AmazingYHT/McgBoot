package com.main.mcg.plugin.dbconn.db2;
...
public class Db2ConnectImpl extends AbstractConnect implements McgConnect {

	public Db2ConnectImpl(DataSource dataSource) {
		super(dataSource);
	}
	...
	public List<Table> getTablesByDataSource(String dbName) throws SQLException {
		...
		return dbConnect.querySql(Table.class,
				"SELECT  name tableName FROM SYSIBM.SYSTABLES", null);	
	}
